...
# RTX 4090 (Ada, sm_89) isn't targeted upstream (this repo predates Ada) --
# add it explicitly, else the extension has no cubin/PTX this GPU can run.
if bare_metal_version >= Version("11.8"):
    cc_flag.append("-gencode")
    cc_flag.append("arch=compute_89,code=sm_89")

if os.path.isdir("csrc/flash_attn/cutlass") and os.listdir("csrc/flash_attn/cutlass"):
    pass  # already vendored locally (not a real git submodule in this checkout)
else:
